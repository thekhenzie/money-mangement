...
export default [
    ...
    //             cb(null, require('./Navigation/Simulator').default);
    //         }, 'simulator');
    //     }
    // },
    {
        path: '/simulator',
        component: require('./Navigation/Simulator').default
    },
    {
        path: '/statements',
        /*  Async WebPack code split  */
        getComponent: (nextState, cb) => {
            require.ensure([], require => {
                cb(null, require('./Navigation/Statements').default);
            }, 'statements');
        }
    },
    {
        ...
        getComponent: (nextState, cb) => {
            require.ensure([], require => {
                cb(null, require('./Navigation/Analytics').default);
            }, 'analytics');
        }
    },
    {
        ...
        getComponent: (nextState, cb) => {
            require.ensure([], require => {
                cb(null, require('./Navigation/RulesEngine').default);
            }, 'rules-engine');
        }
    },
    {
        ...
        getComponent: (nextState, cb) => {
            require.ensure([], require => {
                cb(null, require('./Navigation/Users').default);
            }, 'users');
        }
    },
    {
        ...
        getComponent: (nextState, cb) => {
            require.ensure([], require => {
                cb(null, require('./Navigation/Admin').default);
            }, 'admin');
        }
    },
    //NOTE: Not used
    ...
    {
        path: '/pages/crop-image',
        component: require('./Pages/CropImage').default
    },
