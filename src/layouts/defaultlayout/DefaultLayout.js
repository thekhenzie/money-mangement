...
import { retrieveLoggedUser, destroyUserLogin } from '../../auth';
const titleBase = 'Envel - ';
...
class DefaultLayout extends React.Component {
    ...
    render() {
        ...
        const profileUser = {
            name: (loggedUser == null) ? `` : loggedUser.firstName + ' ' + loggedUser.lastName,
            avatar: faker.image.avatar(),
            isAdmin: (loggedUser == null) ? `` : loggedUser.isAdmin
        };
        ...
        return (
            ...
            >
                <Layout.Navigation>
                    ...
                    >
                        <Navbar.Header>
                            <Navbar.Brand>
                                <Link to='/'>
                                    <img src={logo} height='25px' alt="Envel Dashboard" />
                                </Link>
                            </Navbar.Brand>
                                    ...
                                    <NavDropdown
                                        title={
                                            <div className={classes.buttonUser}>
                                                ...
                                                <span className="m-r-1 v-a-m text-white">
                                                    {profileUser.name}
                                                </span>
                                                <AvatarImage
                                                    size='small'
                                    ...
                                    if (this.props.sidebarAddon === SIDEBAR_ADDON_DEFAULT) {
                                        return (
                                            <div className="sidebar-logo">
                                                <img className="logo-default" width={53} src={logo} />
                                                <img className="logo-slim" height={13} src={logo} />
                                            </div>
                                        );
                                    } else {
                ...
                {/* TODO: Removed OutsideClick and LayoutOptions */}
                {/* <OutsideClick
                ...
                <Footer fluid={!staticFootNavContainer}>
                    <p className="text-gray-dark">
                        <strong className="m-r-1">
                            <span className="text-gray-dark">© 2017 Copyright Artler Capital, Inc.</span>
                        </strong>
                    </p>
                </Footer>
